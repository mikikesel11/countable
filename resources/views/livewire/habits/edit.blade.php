        ...
        <div class="flex-col justify-between items-center mx-auto my-auto">
            ...
            <div class="flex-col py-2 basis-1/2 mx-auto my-auto">
                <div class="basis-1/2 mx-auto my-auto">
                    <input type="radio" class="dark:bg-gray-800" aria-label="Checkbox Count" id="CHECK" name="type" wire:model="type" value="Check" aria-disabled="disabled" disabled/>
                    <label for="CHECK" class="mt-6">Checkbox style counts</label>
                </div>
                <div class="basis-1/2 mx-auto my-auto">
                    <input type="radio" class="dark:bg-gray-800" aria-label="Numeric Count" id="NUMBER" name="type" wire:model="type" value="Number" aria-disabled="disabled" disabled selected/>
            ...
            <div class="flex-col py-2 basis-1/2 mx-auto my-auto">
                <div class="basis-1/2 mx-auto my-auto">
                    <input type="radio" class="dark:bg-gray-800" aria-label="Checkbox Count" id="CHECK" name="type" wire:model="type" value="Check" aria-disabled="disabled" disabled checked />
                    <label for="CHECK" class="mt-6">Checkbox style counts</label>
                </div>
                <div class="basis-1/2 mx-auto my-auto">
                    <input type="radio" class="dark:bg-gray-800" aria-label="Numeric Count" id="NUMBER" name="type" wire:model="type" value="Number" aria-disabled="disabled" disabled />
                    <label for="NUMBER" class="mt-6">Numeric style counts</label>
                </div>
                <x-input-error :messages="$errors->get('type')" class="mt-2" />
            </div>
            @endif
            <div class="flex-col py-2 basis-1/2 mx-auto my-auto">
                <input type="checkbox" wire:model.boolean="active" id="active" name="active" class="mt-1 dark:bg-gray-800 dark:text-white" />
